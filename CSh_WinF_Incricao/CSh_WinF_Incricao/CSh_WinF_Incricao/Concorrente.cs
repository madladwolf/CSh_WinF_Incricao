...
namespace CSh_WinF_Incricao
{
    public class Concorrente
    {
        ...
        {
            Curso = c; ParteDia = p; Nome = n; DataNasc = dN.Date; Loc = l; Sexo = s;
        }
        public Concorrente(Concorrente c)
        {
            Curso = c.Curso; ParteDia = c.ParteDia; Nome = c.Nome; DataNasc = c.DataNasc.Date; Loc = c.Loc; Sexo = c.Sexo;
        }

        public override string ToString()
        {
            return Curso + " " + ParteDia + " " + Nome + " " + DataNasc.ToString(("dd/MM/yyyy")) + " " + Loc + " " + Sexo;
        }
